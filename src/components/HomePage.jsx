        ...
        <section className="rules">
          <div className="rules__container">
            ...
            <p>
              ...
              where timer will reset to one minute and if you are good enough
              you will give try to beat <span>BOSS</span>. In every stage timer
              goes down quicker. Good Luck!
            </p>
